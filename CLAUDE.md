...
- **Текущ статус (обновено 2026-08-14)**: предупреждение в TaskForm при липсващ Gmail App Password + `platform` поле на задачите (Facebook/Instagram/TikTok/LinkedIn/X/Google/Други със свободен текст) — билднати и в момента на пушване. Няма чакаща некомитната работа след това.
